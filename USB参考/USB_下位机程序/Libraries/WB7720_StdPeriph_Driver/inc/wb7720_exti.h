...
#ifndef __WB7720_EXTI_H
#define __WB7720_EXTI_H
...
#define EXTI_Line16      ((uint32_t)0x010000)   /*!< External interrupt line 16 Connected to the Brown-Out Detection (BOD) Output */
#define EXTI_Line17      ((uint32_t)0x020000)   /*!< External interrupt line 17 Connected to the RTC Alarm interrupt */
#define EXTI_Line18      ((uint32_t)0x040000)   /*!< External interrupt line 18 Connected to the RTC Overflow interrupt */
#define EXTI_Line19      ((uint32_t)0x080000)   /*!< External interrupt line 19 Connected to the RTC Second interrupt */
#define EXTI_Line20      ((uint32_t)0x100000)   /*!< External interrupt line 20 Connected to the USB Wakeup event */
#define EXTI_Line21      ((uint32_t)0x200000)   /*!< External interrupt line 21 Connected to the CMP0 interrupt */
#define EXTI_Line22      ((uint32_t)0x400000)   /*!< External interrupt line 22 Connected to the CMP1 interrupt */

#define IS_EXTI_LINE(LINE) ((((LINE) & (uint32_t)0xFF800000) == 0x00) && ((LINE) != (uint32_t)0x00))
