...
void hal_gpio_init(void)
{
	...
	GPB->O_EN.BITS.PIN3 = 1;
	GPB->DOUT.BITS.PIN3 = 1;
	GPB->ODEN.BITS.PIN3 = 0;
	GPB->PUEN.BITS.PIN3 = 0;
	GPB->PDEN.BITS.PIN3 = 0;
	GPB->MODE.BITS.PIN3 = 2; //00:PB3 01:JTAG_CLK 10:BPWM7 11:RESERVED
	...
	{
		GPB->I_EN.BITS.PIN4 = 0;
		GPB->O_EN.BITS.PIN4 = 1;
		GPB->DOUT.BITS.PIN4 = 1;
		GPB->ODEN.BITS.PIN4 = 0;
		GPB->PUEN.BITS.PIN4 = 0;
		GPB->PDEN.BITS.PIN4 = 0;
		GPB->MODE.BITS.PIN4 = 2; //00:PB4 01:JTAG_DAT 10:BPWM8 11:RESERVED
		GPB->ITEN.BITS.PIN4 = 0;
		GPB->ITTP.BITS.PIN4 = 0; //00:Falling Edge 01:Rising Edge 1x:both edge
	}
	...
	GPC->O_EN.BITS.PIN4 = 1;
	GPC->DOUT.BITS.PIN4 = 1;
	...
	/* PC5 */
	GPC->I_EN.BITS.PIN5 = 0;
	GPC->O_EN.BITS.PIN5 = 1;
	...
	/* PC6 */
	GPC->I_EN.BITS.PIN6 = 0;
	GPC->O_EN.BITS.PIN6 = 1;
	GPC->DOUT.BITS.PIN6 = 1;
	GPC->ODEN.BITS.PIN6 = 0;
	GPC->PUEN.BITS.PIN6 = 0;
	...
	GPC->MODE.BITS.PIN8 = 2; //00:CC2_L 01:PC8 10:BADC5 11:RESERVED
	...
	/* PD6 */
	GPD->I_EN.BITS.PIN6 = 0;
	GPD->MODE.BITS.PIN6 = 0; //00:PD6 01:BADC3 10:RESERVED 11:RESERVED
}
