...
#define _SET_I2CM_SCL_IN_PUT()    do {VIC_vModuleDisable(); _I2CM_SCL_PORT->O_EN.BITS._I2CM_SCL_PINx = 0; _I2CM_SCL_PORT->I_EN.BITS._I2CM_SCL_PINx = 1; VIC_vModuleEnable();} while (0)
