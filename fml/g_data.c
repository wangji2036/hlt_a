...
void product_info_print(void)
{
	...
	static const struct
	{
	    ...
	    {ADDR_BATTERY_SERIAL1 - AP_CFG_ROM_ADDR_PRO_INFO, SERIAL_FIELD_SIZE, "Cell SN1"},
	    {ADDR_BATTERY_SERIAL2 - AP_CFG_ROM_ADDR_PRO_INFO, SERIAL_FIELD_SIZE, "Cell SN2"},
	    {ADDR_NU171X_CHECKSUM - AP_CFG_ROM_ADDR_PRO_INFO, PRODUCT_CHECKSUM_FIELD_SIZE, "NU171X CRC"},
	    {ADDR_WB7720_CHECKSUM - AP_CFG_ROM_ADDR_PRO_INFO, PRODUCT_CHECKSUM_FIELD_SIZE, "WB7720 CRC"}};
