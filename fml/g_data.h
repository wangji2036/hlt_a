...
#define SERIAL_FIELD_SIZE 24
#define PRODUCT_SERIAL_FIELD_SIZE 32
#define PRODUCT_CHECKSUM_FIELD_SIZE 4
#define PRODUCT_INFO_TOTAL_SIZE 208
#define PRODUCT_INFO_VERSION 0x0006
...
#define ADDR_BATTERY_SERIAL2 (AP_CFG_ROM_ADDR_PRO_INFO + 176)
#define ADDR_NU171X_CHECKSUM (AP_CFG_ROM_ADDR_PRO_INFO + 200)
#define ADDR_WB7720_CHECKSUM (AP_CFG_ROM_ADDR_PRO_INFO + 204)
#define ADDR_PRODUCT_INFO_VERSION (AP_CFG_ROM_ADDR_PRO_INFO + PRODUCT_INFO_TOTAL_SIZE)

// Product information structure: 208 bytes, stored in Flash as raw struct bytes.
typedef struct
{
